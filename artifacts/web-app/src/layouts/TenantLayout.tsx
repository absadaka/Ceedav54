...
function Sidebar({
  ...
  return (
    ...
    >
      ...
      >
        {collapsed ? (
          <span style={{ fontFamily: "'Dubai', sans-serif", fontSize: 18, fontWeight: 700, lineHeight: 1, color: dark ? "#ffffff" : "#0a0a0a" }}>c<span style={{ fontSize: "1.4em", lineHeight: 0.8, position: "relative", top: "0.08em" }}>»</span></span>
        ) : (
