...
function TermsOfService() {
  return (
    <section id="terms" className="scroll-mt-24">
      ...
      <SectionIntro>
        These Terms of Service govern your access to and use of CEEDA, including our websites, web
        application, mobile/tablet applications, dashboards, APIs, and related services. By creating
        an account, using CEEDA, signing an order form, or accessing the platform on behalf of a
      ...
      <H3>1. About CEEDA</H3>
      <P>
        CEEDA is a business-to-business software platform designed to help automotive workshops and
        ...
        activities. CEEDA is provided to businesses, not to individual consumers for personal use.
      </P>

      <H3>2. Definitions</H3>
      <P>In these Terms:</P>
      <Ul items={[
        '"CEEDA," "we," "us," or "our" means the CEEDA legal entity.',
        '"Customer," "you," or "your" means the business, workshop, company, or person using CEEDA.',
        '"Tenant" means the business workspace created inside CEEDA for a Customer.',
        '"User" means an employee, contractor, technician, advisor, manager, administrator, or other person invited to use CEEDA under a Customer account.',
        '"Customer Data" means data uploaded, entered, created, stored, or processed by you or your Users through CEEDA.',
        ...
        '"Services" means the CEEDA platform, applications, websites, APIs, tools, features, and support services.',
      ]} />

      <H3>3. Eligibility and Authority</H3>
      <P>You may use CEEDA only if you have the legal authority to enter into these Terms. If you use CEEDA on behalf of a business, you confirm that:</P>
      <Ul items={[
        "You are authorized to bind that business to these Terms.",
        "The business is responsible for all Users under its account.",
        "The business is responsible for all Customer Data entered into CEEDA.",
      ...
      <P>You are responsible for how you use CEEDA and for all activity under your Tenant. You must:</P>
      <Ul items={[
        "Use CEEDA lawfully and only for legitimate business purposes.",
        "Obtain all required permissions and notices before entering personal data into CEEDA.",
        "Ensure that customer, vehicle, employee, and workshop data is accurate and lawfully collected.",
        "Use CEEDA in compliance with applicable privacy, employment, consumer protection, automotive, tax, invoicing, payment, and communications laws.",
        "Review estimates, invoices, reports, and job details before sending them to your customers.",
        "Keep backups of any data you are legally required to retain outside CEEDA where appropriate.",
      ]} />
      ...
      <Ul items={[
        ...
        "Attempt to gain unauthorized access to CEEDA, other accounts, systems, or networks.",
        "Interfere with the security, availability, or performance of CEEDA.",
        "Reverse engineer, copy, resell, sublicense, or misuse CEEDA except as allowed by these Terms.",
        "Use CEEDA to send spam, unlawful marketing messages, or unauthorized communications.",
        "Upload sensitive personal data unless necessary, lawful, and properly protected.",
        "Use CEEDA for high-risk purposes where failure could cause serious harm, injury, or unlawful outcomes.",
      ...
      <P>CEEDA may offer free, trial, beta, monthly, annual, or custom plans. You agree to pay all fees shown in your selected plan, order form, invoice, or checkout page. Unless stated otherwise:</P>
      <Ul items={[
      ...
      <P>You are responsible for maintaining accurate billing and payment information. If you are using a free or beta plan, CEEDA may limit, modify, suspend, or discontinue that plan at any time.</P>
      ...
      <P>We aim to provide a reliable service, but we do not guarantee that CEEDA will always be available, uninterrupted, secure, or error-free. The service may be unavailable because of maintenance, updates, internet or hosting issues, third-party service failures, security incidents, force majeure events, or customer-side device, browser, network, or configuration issues. Support availability may depend on your plan.</P>

      <H3>10. Third-Party Services and Integrations</H3>
      <P>CEEDA may integrate with third-party services such as payment processors, email providers, WhatsApp or messaging providers, identity providers, analytics tools, hosting providers, storage providers, accounting tools, or parts/service data providers. Third-party services are governed by their own terms and privacy policies. We are not responsible for third-party platforms, outages, fees, data handling, errors, or service changes. You are responsible for ensuring that your use of third-party integrations is lawful and suitable for your business.</P>

      <H3>11. Payments and Invoices</H3>
      <P>If CEEDA enables payment collection, payment links, online invoices, deposits, or payment status tracking, those services may be processed by third-party payment providers. CEEDA is not a bank, payment institution, escrow provider, tax advisor, or accounting firm. You are responsible for checking invoices, taxes, payment records, refunds, chargebacks, and compliance with local tax and accounting requirements.</P>

      <H3>12. Customer Data Ownership</H3>
      <P>You own your Customer Data. By using CEEDA, you grant us a limited right to host, store, process, transmit, display, and use Customer Data only as necessary to provide the Services, maintain and secure the platform, support your account, troubleshoot issues, improve service performance, comply with law, and enforce these Terms. We do not sell your Customer Data.</P>

      <H3>13. CEEDA Intellectual Property</H3>
      <P>CEEDA, including the software, design, workflows, dashboards, user interface, features, documentation, branding, logos, know-how, and technology, belongs to CEEDA or its licensors. You may not copy, modify, distribute, sell, lease, reverse engineer, or create derivative works from CEEDA unless we give written permission. Feedback, suggestions, or ideas you provide may be used by CEEDA without restriction or compensation.</P>

      <H3>14. Aggregated and Anonymized Data</H3>
      <P>We may create aggregated or anonymized data from platform usage, such as usage trends, performance metrics, workflow statistics, and product improvement insights. We may use this data to improve CEEDA, develop features, benchmark performance, and understand market needs, provided it does not identify you, your Users, or your customers.</P>

      <H3>15. Confidentiality</H3>
      <P>Each party may receive confidential information from the other. Both parties agree to protect confidential information using reasonable care and to use it only for purposes related to CEEDA. Confidential information does not include information that is public, independently developed, lawfully received from another source, or required to be disclosed by law.</P>

      <H3>16. Data Protection</H3>
      <P>Our Privacy Policy explains how we process personal data. For End Customer Data and workshop operational data uploaded by you, you are generally the controller or equivalent responsible party, and CEEDA acts as a processor or service provider, unless we state otherwise. You are responsible for providing required privacy notices to your customers, employees, and Users and for ensuring you have a lawful basis to upload and process their data in CEEDA. If required, we may provide a Data Processing Addendum for customers subject to GDPR, UAE PDPL, Saudi PDPL, or other applicable privacy laws.</P>

      <H3>17. Security</H3>
      <P>We use reasonable technical and organizational measures designed to protect CEEDA and Customer Data. However, no system is completely secure. You are responsible for using strong passwords, managing User access, keeping devices secure, training staff, and promptly reporting suspected security issues.</P>
      ...
      <P>We may suspend or terminate access if you fail to pay fees, breach these Terms, your use creates legal, security, operational, or reputational risk, we are required to do so by law, you misuse the platform or third-party integrations, your account remains inactive for a long period, or we discontinue the service or a plan. You may stop using CEEDA at any time. Cancellation terms may depend on your selected plan or order form. Termination does not remove obligations that should reasonably survive, including payment obligations, confidentiality, intellectual property, liability limits, and dispute terms.</P>

      <H3>20. Disclaimers</H3>
      <P>CEEDA is provided on an "as is" and "as available" basis. To the maximum extent permitted by law, we disclaim warranties of merchantability, fitness for a particular purpose, non-infringement, uninterrupted operation, error-free performance, and accuracy of outputs. CEEDA does not guarantee business results, revenue growth, customer retention, workshop profitability, legal compliance, tax compliance, or error-free estimates, inspections, invoices, or reports. You must review and approve all business documents, quotes, invoices, service records, customer communications, and decisions before relying on them.</P>

      <H3>21. Limitation of Liability</H3>
      <P>To the maximum extent permitted by law, CEEDA will not be liable for indirect, incidental, special, consequential, punitive, or exemplary damages, including loss of profits, loss of revenue, loss of goodwill, loss of data, business interruption, or cost of substitute services. To the maximum extent permitted by law, CEEDA's total liability for all claims related to the Services will not exceed the amount you paid to CEEDA in the three months before the event giving rise to the claim, or AED 500, whichever is lower. Nothing in these Terms limits liability that cannot legally be limited.</P>

      <H3>22. Indemnity</H3>
      <P>You agree to defend, indemnify, and hold CEEDA harmless from claims, damages, losses, liabilities, costs, and expenses arising from:</P>
      <Ul items={[
        "Your use of CEEDA.",
        "Your Customer Data.",
      ...
      <P>We may update CEEDA or these Terms from time to time. If changes are material, we will take reasonable steps to notify you. Continued use of CEEDA after changes become effective means you accept the updated Terms.</P>
      ...
      <P>CEEDA will not be responsible for delays or failures caused by events outside our reasonable control, including natural disasters, war, civil unrest, cyberattacks, internet failures, hosting failures, power outages, government actions, labor disruptions, supplier failures, or other force majeure events.</P>
    </section>
  );
}
...
function PrivacyPolicy() {
  return (
    <section id="privacy" className="scroll-mt-24">
      ...
      <SectionIntro>
        This Privacy Policy explains how CEEDA collects, uses, stores, shares, and protects personal
        data when you use our websites, web application, mobile/tablet applications, dashboards,
        APIs, and related services. CEEDA is designed for business customers such as auto workshops,
        garages, service centers, and automotive service companies.
      </SectionIntro>

      <H3>1. Who We Are</H3>
      <P>CEEDA is a software platform that helps automotive workshops manage bookings, inspections, estimates, quotations, job cards, technician workflows, customer communication, invoicing, reporting, and related operations. For privacy questions, contact us at <a href="mailto:info@ceeda.me" className="text-primary hover:underline">info@ceeda.me</a>.</P>

      <H3>2. Our Role: Controller and Processor</H3>
      <P>Depending on the situation, CEEDA may act as either a controller or a processor.</P>
      <P><strong>When CEEDA is a controller:</strong> CEEDA is generally the controller for personal data we collect for our own business purposes, such as website visitors, account registration, billing and subscription management, sales and support communications, product analytics, security monitoring, marketing communications, and legal and compliance purposes.</P>
      <P><strong>When CEEDA is a processor:</strong> For personal data that our business customers upload, enter, or manage inside CEEDA about their own customers, employees, technicians, vehicles, jobs, inspections, estimates, invoices, and communications, the Customer is generally the controller or equivalent responsible party, and CEEDA acts as a processor or service provider. This means the Customer decides why and how that data is processed, and CEEDA processes it on the Customer's instructions. If you are an end customer of a workshop using CEEDA, please contact that workshop directly for privacy requests related to your service record, vehicle, invoice, estimate, or communication history.</P>
      ...
      <Ul items={[
        "Provide, operate, and maintain CEEDA.",
        ...
        "Protect CEEDA, our Customers, Users, and third parties.",
      ]} />
      ...
      <Ul items={[
        "Contract: to provide CEEDA and manage your account.",
      ...
      <P>We may update this Privacy Policy from time to time. If we make material changes, we will take reasonable steps to notify you. The updated version will be posted with a new "Last updated" date. Continued use of CEEDA after changes become effective means you acknowledge the updated Privacy Policy.</P>

      <P>For any inquiries or more details, contact us at <a href="mailto:info@ceeda.me" className="text-primary hover:underline">info@ceeda.me</a>.</P>
    </section>
  );
}
      ...
      <div className="border-b border-gray-100 bg-gray-50/60">
        <div className="max-w-3xl mx-auto px-6 py-16">
          ...
          <p className="text-gray-500 text-base leading-relaxed">
            Everything you need to know about how CEEDA works and how we handle your data.
          </p>
      ...
      <div className="max-w-3xl mx-auto px-6 py-14 space-y-0">
        ...
        <div className="mt-16 pt-8 border-t border-gray-100 text-center">
          <p className="text-sm text-gray-400">
            ...
            <a href="mailto:info@ceeda.me" className="hover:text-primary transition-colors">
              info@ceeda.me
            </a>
          </p>
        </div>
