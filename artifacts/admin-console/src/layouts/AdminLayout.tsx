      ...
      <div className={cn(
        ...
        {collapsed ? (
          <span style={{ fontFamily: "'Dubai', sans-serif", fontSize: 26, fontWeight: 700, lineHeight: 1 }}>
            ...
            <span style={{ color: light ? "#0a0a0a" : "#ffffff", fontSize: "1.4em", lineHeight: 0.8, position: "relative", top: "0.18em" }}>»</span>
          </span>
        ) : (
          <div className="flex flex-col min-w-0">
            <span style={{ fontFamily: "'Dubai', sans-serif", fontSize: 32, fontWeight: 700, lineHeight: 1 }}>
              ...
              <span style={{ color: light ? "#0a0a0a" : "#ffffff", marginLeft: 1, fontSize: "1.4em", lineHeight: 0.8, position: "relative", top: "0.18em" }}>»</span>
            </span>
